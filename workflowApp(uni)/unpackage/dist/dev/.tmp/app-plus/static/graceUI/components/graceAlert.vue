...
.grace-alert{width:90%; padding:10px 5%; flex-wrap:nowrap; background:#FFF; position:fixed; z-index:99999; left:0; top:-60px; box-shadow:5px 3px 3px #F7F8F9;}
.grace-alert .right{color:#00B26A !important;}
.grace-alert .error{color:#FF0000 !important;}
.grace-alert .msg{color:#00B26A !important;}
.grace-alert .icon{width:30px; line-height:30px; justify-content:center; flex-shrink:0; margin-right:12px;}
