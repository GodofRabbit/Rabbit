...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class='your_position'>
			您现在的位置:&nbsp;
			<a href='/dangdang/main/main.jsp'>在线购物系统</a> &gt;&gt;
			...
			<div class="book_center">
				...
				<div id="divRight" class="list_right">
						...
						<c:if test="page!=1">	
							<div class='list_r_title_text3a'>
								<a name=link_page_next
									href="/dangdang/search/search?pid=${pid}&page=${page-1}&keyword=${keyword}">
					...
					<c:if test="books.size()==0">
						<table width="100%">	
						<tr><td align="center" valign="middle">抱歉没有搜索到相关结果</td></tr>
						</table>
					</c:if>
						...
						<div class="list_r_list" >
							<span class="list_r_list_book"><a name="link_prd_img" href='/dangdang/main/product?id=${id}'>
								<img src="../productImages/${productPic}" /> </a> </span>
							<h2>
								<a name="link_prd_name" href='/dangdang/main/product?id=${id}'>${productName}</a>
							</h2>
