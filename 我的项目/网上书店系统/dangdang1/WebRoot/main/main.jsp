...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script>
			$(function(){
				$("#new").load("/dangdang/main/getNew");
				$("#left").load("/dangdang/main/getCats");
				$("#recommend").load("/dangdang/main/recommend");
				$("#hot").load("/dangdang/main/getHot");
				$("#NewProduct_1_o_t").children().eq(0).load("/dangdang/main/getRank");
