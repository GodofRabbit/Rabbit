...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
		 ...
		 var txtPassword1y=false;
			...
			$(function(){
				$("#txtEmail").blur(function(){
					...
					if(!t.match("\\w+@\\w+(\\.[a-zA-Z]{2,3})+")){
						txtEmaily=false;
					   $("#email\\.info").text("邮箱格式不正确");
					   $(".login_in").hide();
					   return;
					}
				$.ajax({
					data:"Email="+t,
				url:"checkEmail2.action",
		 ...
		 if(txtEmaily==false){
		  ...
		  return txtEmaily&&txtNickNamey&&txtPasswordy&&txtPassword1y;
  			});
  		});
		</script>
	</head>
	<body>
		...
		<div class="fill_message">
			<form name="ctl00" method="post" action="/dangdang/main/addUserB.action" id="f">
				<h2>
					以下均为必填项
				</h2>
