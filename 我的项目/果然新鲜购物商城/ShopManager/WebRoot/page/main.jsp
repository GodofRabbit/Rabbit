...
<body class="childrenBody">
	<div class="panel_box row">
		...
		<div class="panel col">
		<form action="${pageContext.request.contextPath}/userServlet?flag=userList" method="post" id="form2">
		...
		<div class="panel col">
			<a href="${pageContext.request.contextPath}/goodsServlet?flag=goodsList">
		...
		<div class="panel col max_panel">
			<a href="${pageContext.request.contextPath}/orderServlet?flag=orderList">
