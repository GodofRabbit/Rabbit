...
<link href="<%=path %>/Front/css/public.css" type="text/css" rel="stylesheet"/>
        ...
        <link rel="stylesheet" type="text/css" href="<%=path %>/Front/css/buyConfirm.css" />
		<script src="<%=path %>/Front/js/jquery-1.11.1.min.js" type="text/javascript"></script>
   		 <script src="<%=path %>/Front/js/unslider.min.js" type="text/javascript"></script>
  	     <script src="<%=path %>/Front/js/index2.js" type="text/javascript"></script>
...
<!--                 </div> -->
                <div class="icon-box">
                    <i class="iconfont"><img src="<%=path %>/Front/images/yes_ok.png"></i>
                </div>
            </div>
                ...
                <div class="box-bd" id="bankList">
                    ...
                    <dt>
                        ...
                        <ul class="payment-list clearfix" >
                           <li> <input class="input_tab1" name="myradio" id="r1" type="radio" checked="checked"/><label for="r1" ><img src="<%=path %>/Front/images/xhw.png" alt=""/></label></label></li>
                            <li><input class="input_tab2" name="myradio" id="r2" type="radio" /><label for="r2" ><img src="<%=path %>/Front/images/zfb.png" alt=""/></label></li>
                            <li> <input class="input_tab2" name="myradio" id="r2" type="radio" /><label for="r2" ><img src="<%=path %>/Front/images/yck.png" alt=""/></label></li>
                           <li>  <input class="input_tab2" name="myradio" id="r2" type="radio" /><label for="r2" ><img src="<%=path %>/Front/images/zxzf.png" alt=""/></label></li>
                             </ul>
                        <div >
                        <div id="test4_1">
...
<div class="modal hide  balance-pay" id="balancePay">
    ...
    <script src="<%=path %>/Front/js/base.min.js"></script>
        ...
        <script type="text/javascript" src="<%=path %>/Front/js/buyConfirm.js"></script>
 ...
 <!--订单提交body部分结束-->
   ...
   <!-- 底部 -->
    ...
    <div class="fixed-buttons">
        <ul>
            <li><a href="#" class="fixed-weixin"><img src="<%=path %>/Front/images/fixed_weixin.png" /><div class="weixin-pic"><img src="<%=path %>/Front/images/qrCode (1).gif"></div></a></li>
            <li><a href="#"><img id="imgBtn-to-top" src="<%=path %>/Front/images/back_top.png" /></a></li>
        </ul>
    </div>
